...
**As of 2026-06-13 (end of Phase 5B Task 2)**:

- Open: **32** (0 high, 5 medium, 27 low)
- Resolved: **12** (9 from 5A heritage + 1 from 5B/T1 + 2 from 5B/T2)
- Wontfix: 0

**Distribution by phase opened**:

- 5A (heritage): 7 open + 11 resolved (#9 #12 #13 #14 #16 #17 #19 open; #1-#8 #10 #11 #15 #18 resolved)
- 5B/T1 (tagsView): 5 open (TV-A..TV-E; #5 resolved)
- 5B/A1 (permission): 3 open (A1-TD1, TD2, TD3)
- 5B/A2 (dict): 4 open (A2-TD1..TD4)
- 5B/A3 (dept): 2 open (A3-TD2 low + A3-TD3 medium)
- 5B/A4 (post): 0 (no new items — extends A2-TD1)
- 5B/A5 (table-state): 3 open (A5-TD1, TD2, TD3)
- 5B/AA (tracker): 0
- 5B/T2.0a: 1 open (T2.0a-TD1; #11 resolved)
- 5B/T2.0b: 1 open (T2.0b-TD1; #6 resolved)
- 5B/T2.1: 0
- 5B/T2.2: 2 open (T2.2-TD1, TD2)
- 5B/T2.2.1 hotfix: 0 (incident only — patterns codified in ADR 0004 + ADR 0006)
- 5B/T2.3: 2 open (T2.3-TD1, TD2)
- 5B/T2.4: 0 (T2.3-TD1 cross-applies)
- 5B/T2.5: 1 open + 1 pending (T2.5-TD1 + TR-pending)
